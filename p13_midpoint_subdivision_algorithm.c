/*12.	Write a program to clip line using midpoint subdivision algorithm.*/
...
void drawwindow()
{ 
setcolor(RED); line(150,100,450,100); line(450,100,450,400); line(450,400,150,400); line(150,400,150,100);
}
...
ptemp.code[0]='1'; 
/* TOP */ 
else ptemp.code[0]='0'; if(p.y>=400)
ptemp.code[1]='1';
 /* BOTTOM */ 
 else ptemp.code[1]='0';
 if (p.x>=450)
...
/* RIGHT */ 
 ...
 /* LEFT */ 
 ptemp.code[3]='1'; 
else ptemp.code[3]='0'; ptemp.x=p.x; 
ptemp.y=p.y; 
return(ptemp);
}
